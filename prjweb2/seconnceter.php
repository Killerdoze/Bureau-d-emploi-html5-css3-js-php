...
<section class="bodi">
	...
	<div class="container">
		<form  name = "Formcnx" action ="Connecter.php"method="post" >
		  <p class="parag">se connecter</p>

		  <input type="text" placeholder="pseudo" id="pseudo" name="Util" required>
	
		  <input type="password" placeholder="Mot de passe" id="mdp" name="Mdp"requiredautocomplete="off"><br>
		  <label id="erreur"></label>
		  
		  <input type="submit" value="Connexion" name ="Connexion"><br>
		    <br>
		  
          <a href="connect.php">S'inscrire</a>
		</form>
